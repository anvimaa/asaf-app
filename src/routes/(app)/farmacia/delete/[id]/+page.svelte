...
<Card.Root class="sm:col-span-2">
	<Card.Header class="pb-3">
		<Card.Title>Deletar medicamento!</Card.Title>
		<Card.Description class="max-w-lg text-balance leading-relaxed">
			Tens a certeza que pretendes deletar o remedio:
			<span class="font-bold uppercase text-red-500">{data.medicamento.nome} </span>
			<br />
			do Sistema?
		</Card.Description>
	</Card.Header>
	<Card.Footer class="gap-4">
		<form method="post" use:enhance>
			<input type="hidden" name="id" value={data.medicamento.id} />

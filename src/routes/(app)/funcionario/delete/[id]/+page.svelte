...
<Card.Root class="sm:col-span-2">
	<Card.Header class="pb-3">
		<Card.Title>Deletar funcionario!</Card.Title>
		<Card.Description class="max-w-lg text-balance leading-relaxed">
			Tens a certeza que pretendes deletar o funcionario:
			<span class="font-bold uppercase text-red-500">{data.funcionario.nome} </span>
			<br />
			do Sistema?
		</Card.Description>
	</Card.Header>

<script lang="ts">
	...
	$: if (form?.deleted) {
		toast.success('analise deletado com sucesso');
	}
</script>

<Card.Root class="sm:col-span-2">
	<Card.Header class="pb-3">
		<Card.Title>Deletar analise!</Card.Title>
		<Card.Description class="max-w-lg text-balance leading-relaxed">
			Tens a certeza que pretendes deletar o analise:
			<span class="font-bold uppercase text-red-500">{data.analise.tipo} </span>
			<br />
			do Sistema?
		</Card.Description>
	</Card.Header>
